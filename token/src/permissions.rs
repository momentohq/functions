...
/// as disposable tokens do not allow the generation of super user tokens.
...
impl Permissions {
    ...
    ///
    /// ```
    /// use momento_functions_token::{Permissions, CachePermissions, TopicPermissions};
    ///
...
impl CachePermissions {
    ...
    /// `with_cache`, and `with_all_items` to configure access.
    pub fn new() -> Self {
        Self {
